...
public class CharacterApiTest {
    ...
    public void getCharactersNamesTest() throws ApiException {
        ...
        String datasource = null;
        String ifNoneMatch = null;
        List<GetCharactersNames200Ok> response = api.getCharactersNames(characterIds, datasource, ifNoneMatch);
    ...
    public void postCharactersAffiliationTest() throws ApiException {
        ...
        String datasource = null;
        String ifNoneMatch = null;
        List<PostCharactersAffiliation200Ok> response = api.postCharactersAffiliation(characters, datasource, ifNoneMatch);
