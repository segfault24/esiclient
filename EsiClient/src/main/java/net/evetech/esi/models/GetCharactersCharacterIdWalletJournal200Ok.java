...
public class GetCharactersCharacterIdWalletJournal200Ok {
  ...
  **/
   ...
   * @return refType
  **/
  @ApiModelProperty(example = "null", required = true, value = "\"The transaction type for the given. transaction. Different transaction types will populate different attributes.\"")
