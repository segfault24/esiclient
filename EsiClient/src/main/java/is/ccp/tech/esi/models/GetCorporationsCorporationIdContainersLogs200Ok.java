...
public class GetCorporationsCorporationIdContainersLogs200Ok {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(loggedAt, containerId, containerTypeId, characterId, locationId, locationFlag, action, passwordType, typeId, quantity, oldConfigBitmask, newConfigBitmask);
  }
