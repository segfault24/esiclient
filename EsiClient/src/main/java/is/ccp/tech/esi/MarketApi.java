...
public class MarketApi {
    ...
    private com.squareup.okhttp.Call getCorporationsCorporationIdOrdersCall(Integer corporationId, String datasource, Integer page, String token, String userAgent, String xUserAgent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/corporations/{corporation_id}/orders/".replaceAll("\\{format\\}","json")
    ...
    /**
     * List orders from a corporation (asynchronously)
     * List market orders placed on behalf of a corporation  --- Alternate route: &#x60;/v1/corporations/{corporation_id}/orders/&#x60;  Alternate route: &#x60;/legacy/corporations/{corporation_id}/orders/&#x60;  Alternate route: &#x60;/dev/corporations/{corporation_id}/orders/&#x60;  --- This route is cached for up to 3600 seconds
     * @param corporationId An EVE corporation ID (required)
     * @param datasource The server name you would like data from (optional, default to tranquility)
     * @param page Which page of results to return (optional, default to 1)
    ...
    private com.squareup.okhttp.Call getMarketsRegionIdTypesCall(Integer regionId, String datasource, Integer page, String userAgent, String xUserAgent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/markets/{region_id}/types/".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "region_id" + "\\}", apiClient.escapeString(regionId.toString()));
